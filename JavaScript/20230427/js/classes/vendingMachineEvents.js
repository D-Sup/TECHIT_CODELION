...
this.btnGet.addEventListener('click', () => {
    ...
    this.getList.querySelectorAll('li').forEach((itemGet) => {
        // this.txtTotal.textContent = parseInt(this.txtTotal.textContent) + parseInt(itemGet.dataset.price) * parseInt(itemGet.querySelector('strong').firstChild.textContent);
...
// 반복되는 parseInt 나 NumberFormat 은 따로 함수를 만들어보기
// 이코드를 리액트로 바꿔보는 것도
