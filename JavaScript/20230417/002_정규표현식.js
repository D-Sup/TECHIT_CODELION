// link: 정규표현식 설명(https://inpa.tistory.com/entry/JS-%F0%9F%93%9A-%EC%A0%95%EA%B7%9C%EC%8B%9D-RegExp-%EB%88%84%EA%B5%AC%EB%82%98-%EC%9D%B4%ED%95%B4%ED%95%98%EA%B8%B0-%EC%89%BD%EA%B2%8C-%EC%A0%95%EB%A6%AC)
// link: 정규표현식 실무예제(https://codepen.io/kvendrik/pen/bGKeEE)
// link: 정규표현식 스킬트리문제(https://school.programmers.co.kr/learn/courses/30/lessons/49993)
...
// # 문제 1
// link: 정규표현식 특정 문자 제거하기문제(https://school.programmers.co.kr/learn/courses/30/lessons/120826)
...
// # 문제2
// link: 숨어있는 숫자의 덧셈문제(https://school.programmers.co.kr/learn/courses/30/lessons/120851)
...
// # 문제3
// link: 369게임문제(https://school.programmers.co.kr/learn/courses/30/lessons/120891)
...
// 못 찾았을때 length라는 프로퍼티가 없는 것으로 
function solution(order) {
  return order.toString().match(/[369]/g)
}
...
// # 문제4
// link: 잘라서 배열로 저장하기 문제(https://school.programmers.co.kr/learn/courses/30/lessons/120913)
...
function solution(my_str, n) {
  let reg = new RegExp(`.{1,${n}}`, 'g') // 마지막 남은 것도 리턴해줘야해서 오답
...
// # 문제5
// link: 숨어있는 숫자의 덤셈문제(https://school.programmers.co.kr/learn/courses/30/lessons/120864)

"abc1Addfggg4556b".match(/\d/g)
"abc1Addfggg4556b".match(/\d+/g)

// reduce에서 초기값 정해주지않으면 오류
...
// # 그룹연습 문제
// 숫자 2자리와 알파벳 하나씩이 매칭되도록 다음의 패턴에서 문자열을 추출하시오. 숫자는 항상 2개만 있고, 알파벳은 1개 이상 있을 수 있습니다.87a99b00fww89e

'gogaooogogooo'.match(/(go)/g); // ['go', 'go', 'go']
'gogaooogogooo'.match(/[go]/g);

console.log("87a99b00fww89e".match(/[0-9]{2}[a-zA-Z]/g));
console.log("87a99b00fww89e".match(/([0-9]{2})([a-zA-Z])/g)); // 숫자 그룹과 문자 그룹으로 나눕니다
...
// # 문제6
// link: 암호문 문제(https://jsalgo.co.kr/?page=2#)

'a10b9r1ce33uab8wc918v2cv11v9'.match(/[rev][0-9]/g)
// > [ 'r1', 'e3', 'v2', 'v1', 'v9' ]  
// 잘 출력되지만 r,e,v, 뒤에 숫자가 10이 있을 경우 오답
